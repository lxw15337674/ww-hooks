      ...
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        var LinkWrapper = function LinkWrapper(Component) {
          return function (_ref) {
            ...
            var hasComplexChildren = /*#__PURE__*/ _react[
              'default'
  ...
  \***********************************************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        function getApiData(apis, identifier, locale, isDefaultLocale) {
          return Object.entries(apis[identifier]).reduce(function (
            expts,
            _ref,
          ) {
  ...
  \***********************************************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        var getDemoUrl = function getDemoUrl(demoId, htmlSuffix) {
          ...
          return [
            isHashRoute ? ''.concat(base, '#') : origin, // compatible with (empty), /base & /base/
            ''
              .concat(
        ...
        function runner(wrapper, motions, cb) {
          ...
          if (index < motions.length) {
            ...
            switch (type) {
              ...
              default:
                console.warn(
                  "[dumi: motion] unknown motion '".concat(current, "', skip."),
                );
                next();
            }
          } else {
  ...
  \****************************************************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        var _classCallCheck = __webpack_require__(
          /*! ./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/classCallCheck */ './node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/classCallCheck.js',
        );

        var _createClass = __webpack_require__(
          /*! ./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/createClass */ './node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/createClass.js',
        );
          ...
          _createClass(ColorChanger, [
            {
              ...
              value: function getColorMedia(color) {
                return window.matchMedia(
                  '(prefers-color-scheme: '.concat(color, ')'),
                );
              },
              /**
  ...
  \**********************************************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        var _defineProperty2 = __webpack_require__(
          /*! ./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/defineProperty */ './node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/defineProperty.js',
        );
                  ...
                  json: JSON.stringify(
                    {
                      ...
                      dependencies: Object.entries(opts.dependencies).reduce(
                        function (r, _ref5) {
                          ...
                          return _objectSpread(
                            _objectSpread({}, r),
                            {},
                            _defineProperty2({}, name, version),
                          );
                        },
                        {
                          'react-dom':
                            ((_opts$dependencies$re =
                              opts.dependencies.react) === null ||
                            _opts$dependencies$re === void 0
                              ? void 0
                              : _opts$dependencies$re.version) || 'latest',
                        },
                      ),
                    },
                    null,
  ...
  \**********************************************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        var useAlgoliaSearch = function useAlgoliaSearch() {
          ...
          var binder = (0, _react().useCallback)(
            function (selector) {
              window.docsearch(
                _objectSpread(
                  {
        ...
        var _default = function _default(locale, code) {
          var processor = function processor() {
            var api = /^zh|cn$/.test(
              ...
              : API_ENDPOINTS['en-US'];
            return ''
              .concat(api, '?skipLibCheck=true&jsx=1#code/')
              .concat(
                _lzString()['default'].compressToEncodedURIComponent(
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var LZString = (function () {
          ...
          var LZString = {
            ...
            decompressFromUint8Array: function decompressFromUint8Array(
              compressed,
            ) {
            ...
            _decompress: function _decompress(
              length,
              resetValue,
              getNextValue,
            ) {
