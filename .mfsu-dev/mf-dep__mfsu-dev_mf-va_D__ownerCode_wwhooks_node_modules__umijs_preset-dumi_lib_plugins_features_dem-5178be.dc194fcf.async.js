(self['webpackChunkwwhooks'] = self['webpackChunkwwhooks'] || []).push([
  ...
  {
    /***/ './.mfsu-dev/mf-va_D__ownerCode_wwhooks_node_modules_@umijs_preset-dumi_lib_plugins_features_demo_getDemoRenderArgs.js':
      /*!*****************************************************************************************************************************!*\
  !*** ./.mfsu-dev/mf-va_D__ownerCode_wwhooks_node_modules_@umijs_preset-dumi_lib_plugins_features_demo_getDemoRenderArgs.js ***!
  \*****************************************************************************************************************************/
      /***/ function (
        ...
        /* harmony import */ var D_ownerCode_wwhooks_node_modules_umijs_preset_dumi_lib_plugins_features_demo_getDemoRenderArgs__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
        ...
        /* harmony default export */ __webpack_exports__['default'] =
          D_ownerCode_wwhooks_node_modules_umijs_preset_dumi_lib_plugins_features_demo_getDemoRenderArgs__WEBPACK_IMPORTED_MODULE_0__.default;
  ...
  \****************************************************************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        var _default = function _default(props, demos) {
          ...
          if (demo) {
            var previewerProps = _objectSpread(
              _objectSpread({}, demo.previewerProps),
              {},
              {
                // disallowed matryoshka
                hideActions: (demo.previewerProps.hideActions || []).concat([
                  'EXTERNAL',
                ]),
              },
            );
            ...
            if (props.location.query.capture !== undefined) {
              ...
              if (
                previewerProps.motions.every(function (motion) {
            ...
            if (inline) {
              ...
              result = [
                _react()['default'].createElement(InlineRender, {
                  render: function render() {
                    ...
                    return _react()['default'].createElement(
                      'div',
                      {},
                      _react()['default'].createElement(demo.component),
                    );
                  },
                }),
              ];
